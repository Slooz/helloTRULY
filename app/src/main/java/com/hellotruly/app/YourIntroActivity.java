...
public class YourIntroActivity extends Activity
{
    ...
    {
        new SaveYourIntroRequest().execute();
    }
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        new GetYourIntroRequest().execute();
    }

    private class GetYourIntroRequest extends AsyncTask<Void, Void, Hello>
    {
        protected Hello doInBackground(final Void... arguments)
        {
            ...
            try
            {
                return helloTruly.retrieveYourIntro(intro).execute();
            }
    ...
    private class SaveYourIntroRequest extends AsyncTask<Void, Void, Void>
    {
        protected Void doInBackground(final Void... arguments)
        {
            ...
            try
            {
                return helloTruly.saveYourIntro(intro).execute();
            }
            catch (final IOException ioException)
            {
            }
